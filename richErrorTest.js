...
// creates a new RichError instance with a locale error passed in
...
console.log(i18next.exists('server'))//true?
console.log(i18next.t(localeErr)) // returns localeErr
console.log(i18next.exists('server.400.forbidden'))// false????
